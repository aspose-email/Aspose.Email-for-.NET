...
var THROTTLE_TIMEOUT = 5000; // 5 seconds
var throttler = null; // throttle handler

var gaEvent = function(action, category) {
    if (!category) {
        category = 'Editor Navbar';
    }
            ...
            t.$ed
                ...
                .on(updateEventName + ' compositionend', function (e) {
                    ...
                    if ((e.ctrlKey || e.metaKey) && (keyCode === 89 || keyCode === 90)) {
                        ...
                        throttler = window.setTimeout(function() {
        ...
        semanticCode: function (force, full, keepRange) {
            ...
            if (t.o.semantic) {
                ...
                if (full) {
                    ...
                    /* commenting this code to fix layout issues
                     by Dmitry Zotov
