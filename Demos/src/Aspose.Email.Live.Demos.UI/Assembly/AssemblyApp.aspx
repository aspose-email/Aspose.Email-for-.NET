<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AssemblyApp.aspx.cs" Inherits="Aspose.Email.Live.Demos.UI.AssemblyApp" %>
    ...
    <div class="col-md-12 pt-5 app-product-section tl" id="dvAppProductSection" runat="server">
        <div class="container">
            ...
            <div class="col-md-9 pull-left">
                ...
                <ul>
                    <li>Supported Documents:<%=" "  + ViewState["validFileExtensions"].ToString().Replace(" or ", ", ")%></li>
