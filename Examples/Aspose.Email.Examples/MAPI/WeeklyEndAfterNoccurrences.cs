// Demonstrates how to give an Outlook task a weekly recurrence that stops after a
...
{
    internal static class WeeklyEndAfterNoccurrences
    {
        public static void Run()
        {
            ...
            // The occurrence count is derived from how many Fridays fall in the range,
            // and then becomes the limit the pattern stops at.
            ...
            var outputPath = Data.Out/"Weekly_out.msg";
            task.Save(outputPath, TaskSaveFormat.Msg);

            Console.WriteLine($"Task recurs every {recurrence.DayOfWeek}, {recurrence.OccurrenceCount} occurrence(s).");
