...
{
    class PrintMessageHeadersAndBody
    {
        public static void Run()
        {
            ...
            // ExStart:PrintMessageHeadersAndBody
            printer.FormattingFlags = Aspose.Email.Printing.MessageFormattingFlags.MailInfo;
            // ExEnd:PrintMessageHeadersAndBody

            // Print the email to an XPS and TIFF file
            printer.Print(message, dataDir + "PrintBodyHeadersXPS_out.xps", Aspose.Email.Printing.PrintFormat.XPS);
            printer.Print(message, dataDir + "PrintBodyHeadersTIFF_out.tiff", Aspose.Email.Printing.PrintFormat.Tiff);            
        }
    }
}
