...
Namespace Aspose.Email.Examples.VisualBasic.Email.Exchange
	Class ExchangeClientSaveMessagesInMSGFormat
		Public Shared Sub Run()
			...
			Dim client As New ExchangeClient("https://Servername/exchange/username", "username", "password", "domain")
			...
			For Each msgInfo As ExchangeMessageInfo In msgCollection
				...
				client.SaveMessage(strMessageURI, dataDir + msgInfo.MessageId & Convert.ToString(".eml"))
			Next
